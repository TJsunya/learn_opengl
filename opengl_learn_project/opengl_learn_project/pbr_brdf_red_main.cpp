...
int main()
{
	...
	Shader pbrShader("pbr_simple_red.vs", "pbr_simple_red.ps");
	...
	Shader prefilterShader("pbr_cubemap.vs", "pbr_prefilter.ps");
	Shader brdfShader("pbr_brdf.vs", "pbr_brdf.ps");
	...
	pbrShader.setFloat("roughness", 0.2);
	pbrShader.setFloat("metallic", 0.2);
	...
	// pre渲染split sum approximation中的辐照积分部分
	...
	prefilterShader.use();
	prefilterShader.setInt("envrionmentMap", 0);
